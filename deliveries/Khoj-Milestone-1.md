...
3. The cleu progress doesn't sync across team members and this is a known issue. We will be working on that as part of [this issue](https://github.com/ayush4345/Khoj/issues/67).
...
| 0b.  | Documentation | [Khoj/wiki](https://github.com/ayush4345/Khoj/wiki), [Readme](https://github.com/ayush4345/Khoj/blob/main/README.md) | All the relevant documentation is available in the Khoj Wiki and [Readme](https://github.com/ayush4345/Khoj/blob/main/README.md). | 
| 0c.  | Testing and Testing Guide | [Product Guide](https://github.com/ayush4345/Khoj/wiki/Product-Guide)| | 
| 0d.  | Article | https://shubhamrasal.com/writing/khoj-progress-update |  | 
